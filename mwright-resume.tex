...
\maketitle
\section{Objective}
To further myself as a computer scientist and programmer by participating in the architecture and development of interesting software projects and research.

\section{Education}
  \cventry{2008-2012 (expected)}{Computer Science \& Mathematics, NCSU}{Raleigh, NC}{}{Overall GPA: 3.974}{CSC \& MA Majors GPA: 4.0}
...
\section{Computer Skills} 
  ...
  \cvline{Software:}{Git, Subversion, Apache, MySQL, Chef, \LaTeX}
  \cvline{Operating Systems:}{Linux (Primarily Debian-based distributions), OS X, Windows, Xen}
\section{Experience} 
  \cventry{Summer 2011}{Technical Solutions Engineering Intern}{Google}{Mountain View, CA}{}{
    \begin{itemize}
      ...
      \item Refactored the Android Partner Frontend device display page to utilize a different backend 
      and added pagination to it and the search results page.
