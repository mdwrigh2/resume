...
\section{\sc Computer \\ Skills} {\sl Languages:} Ruby, C, Python, Java\\
	       {\sl Software:} Git, Subversion, Apache, MySQL, Capistrano, Mongrel, Monit, Chef, \LaTeX \\
                {\sl Operating Systems:} Linux (Primarily Debian-based distrobutions), OS X, Windows, Xen, VMWare Server ESXi. \\
